...
export default function AdminDiscounts() {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <SEO title="Discount Settings | ZXCHUB Admin" description="Configure review rewards and affiliate commission settings." />
      {toast && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <section className="bg-[#1e293b] border border-slate-800 rounded-xl p-6">
          ...
          <div className="mt-5 rounded-lg border border-slate-800 bg-[#0f172a] p-4 text-sm text-slate-300">
            Reward text: <span className="text-white">Leave a 4+ star review to unlock {reviewDiscountPercent}% off your next purchase.</span>
          </div>
        </section>
