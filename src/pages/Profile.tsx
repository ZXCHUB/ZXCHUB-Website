...
export default function Profile() {
  ...
  return (
    <div className="w-full">
      <SEO title="My Profile | ZXCHUB" description="Manage your purchases, tickets, and account settings." />
      <Navbar />
      <Toast toast={toast} />
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6">
          <div className="text-sm text-zinc-400 mb-1">Balance</div>
          <div className="text-xs text-zinc-500 mb-4">Account credit from promos or manual adjustments.</div>
...
function PurchasesTab({ user, profile, setActiveTab }: { user: any, profile: any, setActiveTab: any }) {
  ...
  const handleDownload = (key: any) => {
    ...
    link.href = url;
    link.download = `zxchub-${key.productName || 'key'}.txt`;
    link.click();
